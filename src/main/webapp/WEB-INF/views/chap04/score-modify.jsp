...
<%--            <li># 국어: <input id="kor" type="text" value="${s.kor}"></li>--%>
<%--            <li># 영어: <input id="eng" type="text" value="${s.eng}"></li>--%>
<%--            <li># 수학: <input id="math" type="text" value="${s.math}"></li>--%>
<%--        </ul>--%>
<%--        <div class="btn-group">--%>
<%--            <a class="list-btn" id="upbtn" href="#">수정완료</a>--%>
<%--            <a class="list-btn2" href="/score/detail?stuNum=${s.stuNum}">이전으로</a>--%>
<%--        </div>--%>
<%--    </section>--%>
...
<%--        let url = "/score/update?stuNum=" + ${s.stuNum} + "&kor=" + kor + "&eng=" + eng + "&math=" + math;--%>
